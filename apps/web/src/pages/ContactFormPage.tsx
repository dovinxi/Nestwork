...
import type { ContactEmail, ContactPhone } from "@nestwork/shared";
    ...
    <div className="mx-auto max-w-2xl">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex justify-end gap-3">
          ...
          <button
            type="submit"
            className="rounded-lg bg-nest-600 px-5 py-2 text-sm font-medium text-white shadow-sm hover:bg-nest-700"
          >
